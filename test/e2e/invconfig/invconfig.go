...
type invWrapperFunc func(*unstructured.Unstructured) inventory.Inventory
...
func CreateInventoryInfo(invConfig InventoryConfig, inventoryName, namespaceName, inventoryID string) inventory.Inventory {
